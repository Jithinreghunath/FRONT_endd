...
@Component({
  selector: 'app-create-emp-app',
  templateUrl: './create-emp-app.component.html',
  styleUrls: ['./create-emp-app.component.css']
})
export class CreateEmpAppComponent implements OnInit {
